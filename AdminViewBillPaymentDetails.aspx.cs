...
public partial class AdminViewBillPaymentDetails : System.Web.UI.Page
{
    SqlConnection con;
    SqlDataAdapter adp;
    DataTable dt;
    ...
    void bindgrid()
    {
        ...
        adp = new SqlDataAdapter("select * from bptable where bpmonth=@bpmonth and bpyear=@bpyear", con);
