<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="AdminViewNotBillPaymentCustomerDetails.aspx.cs" Inherits="AdminViewNotBillPaymentCustomerDetails" %>
        ...
        <tr>
            <th colspan ="2">
                <h1 style ="line-height :30px; font-size :x-large ; ">
                    Bill Not Payment Customer Details</h1>
            </th>
        </tr>
        <tr>
